            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('registrations.index') }}" method="GET" class="row">
                            <div class="col-6">
                        ...
                        <table class="table">
                            ...
                            @foreach($registrations as $registration)
                                <tr>
                                    ...
                                    <td>{{ 'Rp ' . number_format($registration->event->price, 0, ',', '.') }}</td>
                                    <td>
                                        <span class="text-{{ $registration->payment_status == 0 ? 'warning' : 'success' }}">
