                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a class="btn btn-success" href="{{ route('payment_confirmations.create') }}">Create New {{ $title }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($registrations as $registration)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('payment_confirmations.show', $registration->paymentConfirmation->id) }}" class="btn btn-primary btn-sm">{{ __('View') }}</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
